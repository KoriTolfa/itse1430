...
namespace HelloWorld
{
    class Program
    {
        ...
        {
            int[] prices = new int[100]; // in c# rrays are always open meaning you never specify the size, the new operator will specify size
        ...
        private static void DisplayArray( int[] values/*, int count*/ )
        {
            ...
            foreach(var item in values)//now working with individual elements
